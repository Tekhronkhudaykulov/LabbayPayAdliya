...
const PaymentInfo = () => {
    ...
    return (
        <>
            <div className="bg-[#F4F4F4] p-[25px] rounded-[35px]">
                <div>
               ...
               <div className="bg-white flex justify-between items-center mt-[20px] p-[15px] rounded-[12px]">
                    ...
                    <div className="grid grid-cols-[60%_1fr] gap-[20px] mt-[10px]">
                        ...
                        <div className="flex flex-col gap-y-[10px]  ">
                            <div onClick={() => navigate(`${APP_ROUTES.PAYMENT_OF_FINE}/${APP_ROUTES.PAYMENT_OF_FINE_CASH}`)} className="flex flex-col justify-center items-center h-full bg-white  rounded-[12px]">
                                <p className="text-[25px]">Наличными</p>
                                <img src={ASSETS.CashMoneyNew} alt="" />
                            </div>
                            <div onClick={() => navigate(`${APP_ROUTES.PAY_TO_CARD}`)} className="flex flex-col justify-center items-center bg-white  h-full rounded-[12px]">
